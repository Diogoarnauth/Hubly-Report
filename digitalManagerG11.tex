...
\input{chapters/system_requirements}
\input{chapters/similar_systems}

\input{chapters/architecture}

\input{chapters/backend}
\input{chapters/database}
\input{chapters/frontend_web}
...
\begin{figure}[H]
    \centering
    \makebox[\textwidth][c]{\includegraphics[width=1.1\textwidth]{./img/ERModel.png}}
