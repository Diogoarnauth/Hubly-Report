...
\subsection{Backend}
\paragraph{}The backend API is responsible for processing the operations requested by the frontend. It implements the application logic related to users, companies, creators, social profiles, search, conversations, tags, ratings, recommendations, coworking teams, invitations and audit logs.
...
\paragraph{}The database component is responsible for storing the persistent data used by the system. Hubly uses a PostgreSQL~\cite{postgreSql} relational database to store information about users, companies, creators, social profiles, sectors, conversations, messages, tags, ratings, authentication data, profile-view history, coworkers, coworking invitations and audit logs.
