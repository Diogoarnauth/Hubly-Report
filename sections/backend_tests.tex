...
For the domain logic residing in our Service Layer, we wrote unit tests using Moq to isolate external system behaviors, such as database repositories and cross-cutting infrastructure concerns. These tests validate:
